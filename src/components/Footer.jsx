                ...
                <div className="text-foreground pb-6 px-5 sm:px-20 xl:px-52">
                    <div className="mx-auto flex justify-between items-center">
                        <p className="text-xs sm:text-sm">
                            © {new Date().getFullYear()} Sejal.<br className="block sm:hidden" />
                            All rights are reserved.
                        </p>
                        <div className="flex items-center gap-8 text-xl text-gray-700 dark:text-gray-500">
                            {/* Github */}
                            <a href="https://github.com/sejal0115" className="" target="_blank" rel="noopener noreferrer" aria-label="Github">
                                <svg
                                    stroke="currentColor"
                                    fill="currentColor"
                                    strokeWidth="0"
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"  stroke="currentColor"
                                    fill="currentColor"
                                    height="1.2em"
                                    width="1.2em" version="1.1" id="Layer_1" viewBox="0 0 512 512" xmlSpace="preserve"    className="hover:text-black dark:hover:text-white">
                                    <g>
                            ...
                            <a
                             ...
                             {/* Dribbble */}
                                    <a
                                        ...
                                        rel="noopener noreferrer"
                                        aria-label="Dribbble "
                                        className='w-5 hover:text-black dark:hover:text-white'
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg"  stroke="currentColor"
                                    fill="currentColor" width="1.2em" height="1.2em" viewBox="0 0 32 32" version="1.1">
                                            <title>dribble</title>
